/* etauspwr.c - etaus random number generator Version 2.0.0          */
...
/* See etausint.c for generating a random signed integer   */

#include "etaus.h"

unsigned int etauspwr(etfmt *et, int bits)
   {
   unsigned int intgr;      /* output UINT */
   intgr = etaus(et) >> (32-bits);
