/* getseed.c - Find prime number  Version 0.1.0                      */
...
/* This program finds the highest prime number equal or less */
...
void putstx(char *pgm)
   ...
   fprintf(stderr,"Example: %s 23456\n", pgm);
   exit(1);
   } /* putstx */
...
int main(int argc, char **argv)
   ...
   prm = atoi(*(argv+1)) | 1;
   if (prm < 3 || prm > 1048575)
      {
      fprintf(stderr,"getseed: parameter "
         "is out of range\n");
      putstx(*argv);
      exit(1);
      } /* if out of range */
